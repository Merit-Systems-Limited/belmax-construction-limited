                    ...
                    <div class="footer-service">
                        ...
                        <ul>
                            ...
                            <li><a href="service-details.html"><span><i class="icofont-double-right"></i></span>Road
                                    Construction</a></li>
                            <li><a href="service-details.html"><span><i class="icofont-double-right"></i></span>Interior
                                    Design</a></li>
                            <li><a href="service-details.html"><span><i class="icofont-double-right"></i></span>Building
                                    Construction</a></li>
                            <li><a href="service-details.html"><span><i class="icofont-double-right"></i></span>Bridge
                                    Construction</a></li>
                        </ul>
                    </div>
                </div>
